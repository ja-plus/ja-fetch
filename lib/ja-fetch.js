...
function checkInterceptorsReturn(rejectedFuncReturn, type, errObj) {
    if (rejectedFuncReturn instanceof Promise) {
        ...
        console.warn(`${type}.interceptor.use(onFulfilled, onRejected): onRejected not return Promise. Use Promise.reject() to jump to next ${type} interceptor's onRejected`);
